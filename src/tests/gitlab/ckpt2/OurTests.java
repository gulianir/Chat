...
public class OurTests extends TestsUtility {
    
    public static void main(String[] args) {
        Item<String, Integer>[] itemArr = makeItemArray(4);
        itemArr[0]= new Item<String, Integer>("well", 1);
        itemArr[1]= new Item<String, Integer>("yeah", 2);
        itemArr[2]= new Item<String, Integer>("and", 3);
        itemArr[3]= new Item<String, Integer>("i", 4);
        
        HeapSort.sort(itemArr, new LargeValueFirstItemComparator<String, Integer>());
        for (int i = 0; i < 4; i++) {
            System.out.println(itemArr[i].key);
        }
    }
    
    @SuppressWarnings("unchecked")
    private static Item<String,Integer>[] makeItemArray(int size) {
...
//      {10, 14, 31, 13, 12, 11, 9, 8, 7, 6, 5, 4, 3, 2, 1, 0}
        System.err.println(nestd((BSTNode) getField(tree, "root")));
